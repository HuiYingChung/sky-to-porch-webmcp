...
function rejectionMessage(result: FloodQueryResult): string {
  ...
  return (
    <div role="status" data-testid="flood-rejection-panel">
      ...
      <p style={{ margin: "8px 0 0", color: "var(--status-warning-fg)", fontSize: "14px" }}>
        Missing evidence is not evidence of no danger. No information from another place was substituted.
      </p>
