...
const ENTRIES: DatasetRegistryEntry[] = [
  ...
  },
  {
    ...
    decision: "defer",
    role:
      "Prepared Canada-wide anonymous OGC source for hydrometric observations, AQHI, weather observations, and forecasts.",
    endpointTemplate: "https://api.weather.gc.ca/collections/{collection}/items?bbox={bbox}&datetime={time}",
    requiresCredential: false,
    ...
    requiredLimitations: [
      "Collections have different schemas, units, quality states, update timing, and geographic coverage.",
      "AQHI, hydrometric observations, weather observations, and forecasts must remain separate evidence types.",
      "No nearby station or returned feature is missing evidence, not safety.",
    ],
    supportedDataModes: ["unavailable"],
  },
  {
